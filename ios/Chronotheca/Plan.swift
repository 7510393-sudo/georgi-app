...
enum Plan {
    ...
    /// Имя системы координат страницы плана.
    ///
    /// В ней строка сообщает, где стоят её цифры, и в ней же страница
    /// ставит барабан времени. Имя общее нарочно: замеряет одна вещь,
    /// а ставит другая, и считать они должны одинаково (решение P173).
    static let space = "страница-плана"
